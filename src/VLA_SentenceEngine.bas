...
Public Function EnglishExpandedVocabularyText(ByVal vocabPath As String) As String
    ...
    stamp = "; GENERATED by EnglishExpandedVocabularyText from " & Dir$(vocabPath) & _
        ...
        "; source-size: " & FileLen(vocabPath) & " bytes - a mismatch against the CURRENT source file's size (probably) means this export is stale for it; re-export before trusting it." & vbCrLf & vbCrLf
